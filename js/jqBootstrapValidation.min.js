...
! function(u) {
  var m = [],
    t = {
      ...
      methods: {
        init: function(a) {
          ...
          var e = u.unique(this.map(function() {
            return u(this).parents("form")[0]
          }).toArray());
          return u(e).bind("submit", function(a) {
            var e = u(this),
              i = 0,
            ...
            t.trigger("submit.validation").trigger("validationLostFocus.validation"), t.each(function(a, e) {
              var t = u(e).parents(".control-group").first();
              t.hasClass("warning") && (t.removeClass("warning").addClass("error"), i++)
            }), t.trigger("validationLostFocus.validation"), i ? (v.options.preventSubmit && a.preventDefault(), e.addClass("error"), u.isFunction(v.options.submitError) && v.options.submitError(e, a, t.jqBootstrapValidation("collectErrors", !0))) : (e.removeClass("error"), u.isFunction(v.options.submitSuccess) && v.options.submitSuccess(e, a))
          }), this.each(function() {
            var l = u(this),
              ...
              n = [];
            if (!i.length && v.options.autoAdd && v.options.autoAdd.helpBlocks && (i = u('<div class="help-block" />'), t.find(".controls").append(i), m.push(i[0])), v.options.sniffHtml) {
              var a = "";
            ...
            void 0 !== l.data("validation") && (n = l.data("validation").split(",")), u.each(l.data(), function(a, e) {
              var t = a.replace(/([A-Z])/g, ",$1").split(",");
              "validation" === t[0] && t[1] && n.push(t[1])
            });
            for (var s = n, d = []; u.each(n, function(a, e) {
                n[a] = g(e)
              }), n = u.unique(n), d = [], u.each(s, function(a, e) {
                if (void 0 !== l.data("validation" + e + "Shortcut")) u.each(l.data("validation" + e + "Shortcut").split(","), function(a, e) {
                  d.push(e)
                });
                else if (v.builtInValidators[e.toLowerCase()]) {
                  var t = v.builtInValidators[e.toLowerCase()];
                  "shortcut" === t.type.toLowerCase() && u.each(t.shortcut.split(","), function(a, e) {
            ...
            u.each(n, function(a, t) {
              var i = l.data("validation" + t + "Message"),
                e = void 0 !== i,
                n = !1;
              if (i = i || "'" + t + "' validation failed \x3c!-- Add attribute 'data-validation-" + t.toLowerCase() + "-message' to input to change this message --\x3e", u.each(v.validatorTypes, function(a, e) {
                  void 0 === c[a] && (c[a] = []), n || void 0 === l.data("validation" + t + g(e.name)) || (c[a].push(u.extend(!0, {
                    name: g(e.name),
                    message: i
                  }, e.init(l, t))), n = !0)
                }), !n && v.builtInValidators[t.toLowerCase()]) {
                var o = u.extend(!0, {}, v.builtInValidators[t.toLowerCase()]);
                e && (o.message = i);
                var r = o.type.toLowerCase();
                "shortcut" === r ? n = !0 : u.each(v.validatorTypes, function(a, e) {
                  void 0 === c[a] && (c[a] = []), n || r !== a.toLowerCase() || (l.data("validation" + t + g(e.name), o[e.name.toLowerCase()]), c[r].push(u.extend(o, e.init(l, t))), n = !0)
                })
              }
              ...
              var i = h(l),
                n = [];
              return u.each(c, function(t, a) {
                (i || i.length || e && e.includeEmpty || v.validatorTypes[t].blockSubmit && e && e.submitting) && u.each(a, function(a, e) {
              ...
              t.find("input,textarea,select").each(function(a, e) {
                var t = o.length;
                if (u.each(u(e).triggerHandler("validation.validation", n), function(a, e) {
                    o.push(e)
                  }), o.length > t) u(e).attr("aria-invalid", "true");
                else {
        ...
        destroy: function() {
          return this.each(function() {
            ...
            a.unbind(".validation"), t.html(t.data("original-contents")), e.attr("class", e.data("original-classes")), a.attr("aria-invalid", a.data("original-aria-invalid")), t.attr("role", a.data("original-role")), -1 < m.indexOf(t[0]) && t.remove()
          })
        },
        ...
        hasErrors: function() {
          var t = [];
          return this.each(function(a, e) {
            t = t.concat(u(e).triggerHandler("getValidators.validation") ? u(e).triggerHandler("validation.validation", {
              submitting: !0
            }) : [])
          }), 0 < t.length
        },
      ...
      validatorTypes: {
        ...
        ajax: {
          ...
          validate: function(e, a, t) {
            return "" + t.lastValue == "" + a && !0 === t.lastFinished ? !1 === t.lastValid : (!0 === t.lastFinished && (t.lastValue = a, t.lastValid = !0, t.lastFinished = !1, u.ajax({
              url: t.url,
    ...
    h = function(a) {
      var e = a.val(),
        t = a.attr("type");
      return "checkbox" === t && (e = a.is(":checked") ? e : ""), "radio" === t && (e = 0 < u('input[name="' + a.attr("name") + '"]:checked').length ? e : ""), e
    };
  u.fn.jqBootstrapValidation = function(a) {
    return t.methods[a] ? t.methods[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof a && a ? (u.error("Method " + a + " does not exist on jQuery.jqBootstrapValidation"), null) : t.methods.init.apply(this, arguments)
  }, u.jqBootstrapValidation = function(a) {
    u(":input").not("[type=image],[type=submit]").jqBootstrapValidation.apply(this, arguments)
  }
}(jQuery);
